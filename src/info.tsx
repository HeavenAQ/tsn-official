...
export const pastEvents: Map<string, YearPastEvents[]> = new Map()
pastEvents.set('2023', [
    {
        year: Year.Year2023,
        month: Month.January,
        events: [
            {
                ...
                jpTitle: '2023 日本台湾陶芸合同展 IN 台湾台中を共催',
                chnLocation: ['台灣台中'],
                jpLocation: ['台湾台中']
            }
        ]
        ...
        events: [
            {
                year: Year.Year2023,
                month: Month.March,
                chnTitle: '台灣嘉義西園雅集茶道教室-千葉縣館山市共同訪問交流',
                jpTitle: '台湾嘉義西園雅集茶道教室-千葉県館山市訪問交流の協力',
            ...
            },
            {
                year: Year.Year2023,
                month: Month.March,
                chnTitle: '主辦千葉縣館山市台灣茶茶會',
                jpTitle: '千葉県館山市台湾茶 茶会を主催',
                chnLocation: ['千葉縣館山市'],
                jpLocation: ['千葉県館山市']
            }
        ]
        ...
        events: [
            {
                year: Year.Year2023,
                month: Month.April,
                chnTitle: '主辦 2023 廣島縣尾道市日本台灣小學作品聯合展演',
                jpTitle: '2023 広島県尾道市日本台湾小学校合同作品展を主催',
                chnLocation: ['廣島縣尾道市'],
                jpLocation: ['広島県尾道市']
            },
            {
                year: Year.Year2023,
                month: Month.April,
                chnTitle: '嘉義市國際教育地方培力團訪問日本的小學校協力',
                jpTitle:
                    '嘉義市国際教育地方培力団が日本の小学校を訪問見学の協力',
                chnLocation: ['嘉義市'],
                jpLocation: ['嘉義市']
            }
        ]
        ...
        events: [
            {
                ...
                month: Month.May,
                chnTitle:
                    '主辦 2023 日本台灣文化藝術交流會第一回定期音樂公演「美麗新營」IN 台灣台南新營',
                jpTitle:
                    '2023 日本台湾文化芸術交流会第１回定期音楽公演「美しい新営」IN 台湾台南新営を主催',
                chnLocation: ['台灣台南新營'],
                jpLocation: ['台湾台南新営']
            }
        ]
        ...
        events: [
            {
                year: Year.Year2023,
                month: Month.July,
                chnTitle: '主辦 2023 日本鳥取-台灣學校聯合作品展演',
                jpTitle: '2023 日本鳥取-台湾学校作品合同展を主催',
                chnLocation: ['日本鳥取'],
                jpLocation: ['日本鳥取県']
            }
        ]
        ...
        events: [
            {
                ...
                month: Month.August,
                chnTitle:
                    '大阪府和泉市舉辦和泉市世界的文化講座 台灣茶體驗—香氣和味道的世界—和泉市教育委員會・和泉市國際交流協會共同主辦',
                jpTitle:
                    '大阪府和泉市にて和泉市世界の文化講座　世界に名立たる台湾茶体験ー香りと味わいの世界ーを和泉市教育委員会・和泉市国際交流協会と一緒に主催',
                chnLocation: ['大阪府和泉市'],
                jpLocation: ['大阪府和泉市']
            },
            {
                ...
                month: Month.August,
                chnTitle:
                    '和歌山市舉辦世界著名的台灣茶體驗—香氣和味道的世界—主辦',
                jpTitle:
                    '和歌山市にて世界に名立てる台湾茶体験ー香りと味わいの世界ーを主催',
                chnLocation: ['和歌山市'],
                jpLocation: ['和歌山市']
            },
            {
                year: Year.Year2023,
                month: Month.August,
                chnTitle: '2023和歌山市第二回台日學校美術作品合同展主辦',
                jpTitle: '2023和歌山市第二回台日学校美術作品合同展を主催',
                chnLocation: ['和歌山市'],
                jpLocation: ['和歌山市']
            }
        ]
